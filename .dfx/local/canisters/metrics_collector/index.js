...
import { idlFactory } from './metrics_collector.did.js';
export { idlFactory } from './metrics_collector.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_METRICS_COLLECTOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./metrics_collector.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the metrics_collector canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./metrics_collector.did.js")._SERVICE>}
 */
export const metrics_collector = createActor(canisterId);
