...
import { idlFactory } from './canistchat_frontend.did.js';
export { idlFactory } from './canistchat_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CANISTCHAT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./canistchat_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the canistchat_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./canistchat_frontend.did.js")._SERVICE>}
 */
export const canistchat_frontend = createActor(canisterId);
