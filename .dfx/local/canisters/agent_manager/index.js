...
import { idlFactory } from './agent_manager.did.js';
export { idlFactory } from './agent_manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AGENT_MANAGER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./agent_manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the agent_manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./agent_manager.did.js")._SERVICE>}
 */
export const agent_manager = createActor(canisterId);
