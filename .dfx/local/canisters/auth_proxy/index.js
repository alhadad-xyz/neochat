...
import { idlFactory } from './auth_proxy.did.js';
export { idlFactory } from './auth_proxy.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AUTH_PROXY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./auth_proxy.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the auth_proxy canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./auth_proxy.did.js")._SERVICE>}
 */
export const auth_proxy = createActor(canisterId);
