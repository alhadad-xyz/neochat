...
import { idlFactory } from './data_storage.did.js';
export { idlFactory } from './data_storage.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DATA_STORAGE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./data_storage.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the data_storage canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./data_storage.did.js")._SERVICE>}
 */
export const data_storage = createActor(canisterId);
