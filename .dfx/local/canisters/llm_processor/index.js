...
import { idlFactory } from './llm_processor.did.js';
export { idlFactory } from './llm_processor.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LLM_PROCESSOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./llm_processor.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the llm_processor canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./llm_processor.did.js")._SERVICE>}
 */
export const llm_processor = createActor(canisterId);
