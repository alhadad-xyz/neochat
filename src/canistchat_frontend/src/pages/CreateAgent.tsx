      ...
      <div className="flex-1 flex flex-col ml-64">
        ...
        <main className="flex-1 p-8">
          <div className="max-w-6xl mx-auto">
            <div className="mb-8">
              <Button variant="ghost" onClick={() => navigate("/dashboard")} className="mb-4 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
            ...
            {showPreview ? <AgentPreview formData={formData} /> : <CreateAgentForm formData={formData} setFormData={setFormData} lastActiveStep={lastActiveStep} setLastActiveStep={setLastActiveStep} />}
          </div>
        </main>
      </div>
    </div>
