    ...
    <Card className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg border border-white/20 dark:border-gray-700/50 shadow-xl">
      ...
      <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {themes.map((theme) => (
              <button
                ...
                className={`p-4 rounded-lg border transition-all ${formData.theme === theme.id ? "border-blue-500 bg-blue-50 dark:bg-blue-900/20" : "border-white/30 dark:border-gray-600/30 bg-white/50 dark:bg-gray-700/50"}`}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="accent-color" className="text-gray-700 dark:text-gray-300">
              Accent Color
            </Label>
            <Input
              id="accent-color"
        ...
        <div className="space-y-2">
          <Label htmlFor="custom-css" className="text-gray-700 dark:text-gray-300">
            Custom CSS
          </Label>
          <Textarea
            id="custom-css"
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-3">
                  <p className="text-sm text-gray-900 dark:text-white">{formData.welcomeMessage || "Hello! How can I help you today?"}</p>
                </div>
              </div>
            </div>
          </div>
